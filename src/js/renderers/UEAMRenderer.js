...
export class UEAMRenderer extends AbstractRenderer {
    ...
    constructor(gl, volume, environmentTexture, options) {
        ...
        // console.log(SHADERS.renderers);

        this._programs = WebGL.buildPrograms(this._gl, SHADERS.renderers.UEAM, MIXINS);
    }
    ...
    _integrateFrame() {
        ...
        gl.uniform1f(uniforms.uEmissionCoefficient, this.albedo * this.extinction);
