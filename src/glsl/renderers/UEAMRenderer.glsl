// #part /glsl/shaders/renderers/UEAM/generate/vertex

void main() {

}

// #part /glsl/shaders/renderers/UEAM/generate/fragment
...
// #part /glsl/shaders/renderers/UEAM/integrate/vertex
...
// #part /glsl/shaders/renderers/UEAM/integrate/fragment
...
void main() {
    ...
    photon.smittance = texture(uTransmittance, mappedPosition).a;
    ...
    for (uint i = 0u; i < uSteps; i++) {
        ...
        if (any(greaterThan(photon.position, vec3(1))) || any(lessThan(photon.position, vec3(0)))) {
            ...
            photon.smittance *= 1.0 - weightA;
            photon.currentRadiance *= 1.0 - weightA;
        } else if (r.y < PAbsorption + PEmission) {
            // emission
            float weightE = muEmission / (uMajorant * PEmission);
            vec3 smittance = weightE * volumeSample.rgb;
            photon.currentRadiance += weightE * volumeSample.rgb * photon.smittance;
        } else {
            // null collision
            float weightN = muNull / (uMajorant * PNull);
            photon.smittance *= weightN;
        }
    }

    oPosition = vec4(photon.position, 0);
    oDirection = vec4(photon.direction, float(photon.bounces));
    oTransmittance = vec4(photon.currentRadiance, photon.smittance);
    oRadiance = vec4(photon.radiance, float(photon.samples));
}

// #part /glsl/shaders/renderers/UEAM/render/vertex
...
// #part /glsl/shaders/renderers/UEAM/render/fragment
...
// #part /glsl/shaders/renderers/UEAM/reset/vertex
...
// #part /glsl/shaders/renderers/UEAM/reset/fragment
